...
<div class="container">
    <div class="row">
        <div class="col-lg-8">
            <div class="form_film">
              <h2>Modifier la fiche de "<?= htmlspecialchars($titre)?>"</h2>
              <form method='POST' action='/work/PiePHP/film/modifyValid' role="form">
                <div class="form-group row">
                  ...
                  <div class="col-6">
                    <input class="form-control champs" type="text" name="title" value="<?= htmlspecialchars($titre)?>" id="title_film">
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-6">
                    <select class="form-control champs" name="genre" id="genre" style="height:35px;">
                      <option selected value="<?= htmlspecialchars($id_genre)?>"><?= htmlspecialchars($genre)?></option>
                      <option value=""></option>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-6">
                    <select class="form-control champs" name="distrib" id="distrib" style="height:35px;">
                      <option selected value="<?= htmlspecialchars($id_distrib)?>"><?= htmlspecialchars($distrib)?></option>
                      <option value=""></option>
                      <?php foreach ($distribs as $key => $value): ?>
                      <option value=<?= htmlspecialchars($key)?>><?= htmlspecialchars($value)?></option>
                      <?php endforeach; ?>
                    </select>
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-6">
                    <input class="form-control champs" type="text" name="annee_prod" value="<?= htmlspecialchars($annee_prod)?>" placeholder="ex: 2001" id="date_prod">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="date_debut" class="col-4 offset-2 col-form-label">date de début de sortie en salle</label>
                  <div class="col-6">
                    <input class="form-control champs" type="date" name="date_debut" value="<?= htmlspecialchars($date_debut)?>" id="date_debut">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="date_fin" class="col-4 offset-2 col-form-label">date de fin d'exploitation en salle</label>
                  <div class="col-6">
                    <input class="form-control champs" type="date" name="date_fin" value="<?= htmlspecialchars($date_fin)?>" id="date_fin">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="duree_min" class="col-4 offset-2 col-form-label">Durée</label>
                  <div class="col-6">
                    <input class="form-control champs" type="text" name="duree_min" value="<?= htmlspecialchars($duree_min)?>" placeholder="en minutes" id="duree_min">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="resum" class="col-4 offset-2 col-form-label">Résumé</label>
                  <div class="col-6">
                    <input class="form-control champs" type="textarea" value="<?= htmlspecialchars($resum)?>" name="resum" id="resum">
                  </div>
                </div>
                <div class="form-group row">
