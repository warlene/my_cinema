            ...
            <div class="form_film">
              ...
              <form method='POST' action=''>
                <div class="form-group row">
                  ...
                  <div class="col-6">
                    <input class="form-control champs" type="text" name="title" id="title_film">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-6">
                    <select class="form-control champs" name="distrib" id="distrib" style="height:35px;">
                      <option value=""></option>
                      @foreach ($distribs as $key => $distrib)
                      <option value={{$key}}>{{$distrib}}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-6">
                    <input class="form-control champs" type="text" name="annee_prod" placeholder="ex: 2001" id="date_prod">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="date_debut" class="col-4 offset-2 col-form-label">date de début de sortie en salle</label>
                  <div class="col-6">
                    <input class="form-control champs" type="date" name="date_debut" id="date_debut">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="date_fin" class="col-4 offset-2 col-form-label">date de fin d'exploitation en salle</label>
                  <div class="col-6">
                    <input class="form-control champs" type="date" name="date_fin" id="date_fin">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="duree_min" class="col-4 offset-2 col-form-label">Durée</label>
                  <div class="col-6">
                    <input class="form-control champs" type="text" name="duree_min" placeholder="en minutes" id="duree_min">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="resum" class="col-4 offset-2 col-form-label">Résumé</label>
                  <div class="col-6">
                    <input class="form-control champs" type="textarea" name="resum" id="resum">
                  </div>
                </div>
                <div class="form-group row">
